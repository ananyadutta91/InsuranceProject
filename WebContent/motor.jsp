...
<input type="hidden" name="action" value="registerMotorPolicy">

Amount Paid : $ <input type="number" name="amount" min="10" required><br>

<br><br><h1><b>Vehicle Details</b></h1><br>

Vehicle Number : <input type="text" name="vehicleNo" required><br>
Engine Number : <input type="text" name="engineNo" required><br>
